  ...
  return (
            ...
            <div className="acu lg:pr-4 text-justify font-montserrat text-primary-paragraph2 text-[18px]">
              ...
              <div className="lg:pl-10 ">
                ...
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    Clicking on the{" "}
                    <span className="text-primary-activelink font-bold">"’+’ Add User"</span>{" "}
                    button, located on the top-left corner of the page, to the
                    left of the{" "}
                    <span className="text-primary-pheading font-bold">"Download Table"</span>{" "}
                    button and to the top of the search options.
                  </li>
                </ol>
                <p className="text-justify mb-4">
                  It will open the{" "}
                  <span className="text-primary-activelink font-bold">"Add New User"</span> page.
                </p>
                <p className="text-justify mb-4">
                  Please keep in mind, all the fields in the single step must be
                  filled properly. Now, let us begin with the first and only
                  step, the{" "}
                  <span className="text-primary-pheading font-bold">"User Information"</span>{" "}
                  step:
                </p>
                <p className="text-justify mb-4">
                  The <span className="text-primary-activelink font-bold">"User Information"</span>{" "}
                ...
                <ul className="list-disc pl-6 mb-4 text-justify">
                  <li>
                    The <span className="text-primary-pheading font-bold">"User Name"</span>{" "}
                  ...
                  <li>
                    The <span className="text-primary-activelink font-bold">"Email Address"</span>{" "}
                    field: Enter the email address of the user that you are
                    adding to the Farm Management System.
                  </li>
                  <li>
                    The <span className="text-primary-pheading font-bold">"Phone Number"</span>{" "}
                  ...
                  <li>
                    The <span className="text-primary-activelink font-bold">"Select Status"</span>{" "}
                    field: This is a non-editable field where it shows what
                    status the user is in on the Farm Management System, i.e.,
                    either they are{" "}
                    <span className="text-primary-pheading font-bold">"Active"</span> or{" "}
                    <span className="text-primary-pheading font-bold">"Blocked"</span>.
                  </li>
                  <li>
                    The <span className="text-primary-activelink font-bold">"User Role"</span>{" "}
                    field: Enter what role the user plays in the overall farm
                    operation that you are running. Please select one of six
                    options:
                    <ul className="list-disc pl-6 mt-2">
                      <li>
                        <span className="text-primary-pheading font-bold">Farm Manager</span>
                      </li>
                      <li>
                        <span className="text-primary-pheading font-bold">Accountant</span>
                      </li>
                      <li>
                        <span className="text-primary-pheading font-bold">Service Manager</span>
                      </li>
                      <li>
                      ...
                      <li>
                        <span className="text-primary-pheading font-bold">Farm Worker</span>
                      </li>
                      <li>
                        <span className="text-primary-pheading font-bold">Auditor</span>
                      </li>
                    </ul>
                  </li>
                  <li>
                    The <span className="text-primary-activelink font-bold">"Image"</span> field:
                    Enter an image of the user that you are adding to the Farm
                    Management System.
                  </li>
                </ul>
                <p className="text-justify mb-4">
                  ...
                  you can select the{" "}
                  <span className="text-primary-pheading font-bold">"Submit"</span> button. You
                  will then be taken back to the{" "}
                  <span className="text-primary-activelink font-bold">"Manage Users"</span> page
                  with your User entry added to the Manage Users table!
                </p>
                ...
                <p className="text-justify mb-4">
                  ...
                  <span className="text-primary-activelink font-bold">"Manage Users"</span> table.
                </p>
                <p className="text-justify mb-4">
                  ...
                  , the <span className="text-primary-pheading font-bold">"Page select"</span>,
                  and the{" "}
                ...
                <ul className="list-disc pl-6 mb-4 text-justify">
                  <li>
                    ...
                    <span className="text-primary-activelink font-bold">"Manage Users"</span>{" "}
                  ...
                  <li>
                    ...
                    the <span className="text-primary-activelink font-bold">"Manage Users"</span>{" "}
                  ...
                  <li>
                    The <span className="text-primary-activelink font-bold">"Go to page"</span>{" "}
                ...
                <p className="text-justify mb-4">
                  ...
                  <span className="text-primary-activelink font-bold">"Manage Users"</span> table
                  in the table within the Farm Management System on a PDF
                ...
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    ...
                    <span className="text-primary-pheading font-bold">"Records per page"</span>{" "}
                    count and set it to the highest number you can set.
                  </li>
                  <li>
                    Next, you can select the{" "}
                    <span className="text-primary-activelink font-bold">"Download Table"</span>{" "}
                    button located on the top-left of the page, to the right of
                    the <span className="text-primary-pheading font-bold">"’+’ Add User"</span>{" "}
                ...
                <p className="text-justify mb-4">
                  ...
                  <span className="text-primary-activelink font-bold">"Manage Users"</span> table
                  and their details. When you have found a suitable place for
                  your PDF file, then you can press the{" "}
                  <span className="text-primary-pheading font-bold">"Save"</span> button, located
                ...
                <p className="text-justify mb-4">
                  ...
                  and go into the{" "}
                  <span className="text-primary-activelink font-bold">"Downloads"</span> section,
                  to view your PDF file, or you can go into the file explorer
                ...
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    First, select the{" "}
                    <span className="text-primary-activelink font-bold">"Three dots"</span> icon
                    [It’ll look like this{" "}
                    <span className="text-primary-pheading font-bold">"⋮"</span>], located on the
                    right side of the User you wish to block.
                  </li>
                  <li>
                  ...
                  <li>
                    Select the <span className="text-primary-pheading font-bold">"Blocked"</span>{" "}
                    button, which will be the 2nd button in the list, above the{" "}
                    <span className="text-primary-activelink font-bold">"View"</span> button.
                  </li>
                </ol>
                <p className="text-justify mb-4">
                ...
                <p className="text-justify mb-4">
                  ...
                  selecting the <span className="text-primary-activelink font-bold">"Name"</span>{" "}
                  of the User you want to check out:
                </p>
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    You can select the{" "}
                    <span className="text-primary-pheading font-bold">"Name"</span> of the User
                    you want to view.
                  </li>
                  <li>
                    You will then be taken to a{" "}
                    <span className="text-primary-activelink font-bold">"View User Details"</span>{" "}
                ...
                <p className="text-justify mb-4">
                  ...
                  <span className="text-primary-activelink font-bold">"Three dots"</span> icon,
                  then clicking the{" "}
                  <span className="text-primary-pheading font-bold">"View"</span> button in the
                  menu that shows:
                </p>
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    ...
                    [It’ll look like this{" "}
                    <span className="text-primary-pheading font-bold">"⋮"</span>], located on the
                    right side of the User you wish to view.
                  </li>
                  <li>
                    You will then see the{" "}
                    <span className="text-primary-activelink font-bold">"extra options"</span> menu
                  ...
                  <li>
                    Select the <span className="text-primary-pheading font-bold">"View"</span>{" "}
                    button, which will be the 1st button in the list, above the{" "}
                    <span className="text-primary-activelink font-bold">"Blocked"</span> button.
                  </li>
                  <li>
                ...
                <p className="text-justify mb-4">
                  ...
                  User, then you can edit the User entry in the table:
                </p>
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    First, select the{" "}
                    ...
                    [It’ll look like this{" "}
                    <span className="text-primary-pheading font-bold">"⋮"</span>], located on the
                    right side of the User that you want to edit.
                  </li>
                  <li>
                    You will then see the{" "}
                    <span className="text-primary-activelink font-bold">"extra options"</span> menu
                  ...
                  <li>
                    Once you are on the{" "}
                    <span className="text-primary-activelink font-bold">"View User"</span> page of
                    the User you want to edit, you can then select the{" "}
                    <span className="text-primary-pheading font-bold">
                      "Edit [shown as a pencil icon]"
                    </span>{" "}
                    button, located at the top-right corner of the page and
                    below the <span className="text-primary-activelink font-bold">"Download"</span>{" "}
                    button.
                  </li>
                  <li>
                    You will then be taken to the{" "}
                    <span className="text-primary-activelink font-bold">"Edit User"</span> page.
                  </li>
                </ol>
                <p>
                  Here you can change and update any of the fields you need to
                  edit. Once you have made your changes and edits, you can then
                  select the "Submit" button. It will then take you back to the
                  "View User" page of the User you edited so you can review your
                  changes and edits.
                </p>
                <p className="text-justify mb-4">
                  Now you can either go to the top-right hand of your browser
                ...
                <p className="text-justify mb-4">
                  Here you can change and update any of the fields you need to
                  edit. Once you have made your changes and edits, you can then
                  select the <span className="text-primary-pheading font-bold">"Submit"</span>{" "}
                  button. It will then take you back to the{" "}
                  <span className="text-primary-activelink font-bold">"View User"</span> page of
                  the User you edited so you can review your changes and edits.
                </p>
                ...
                <p className="text-justify mb-4">
                  If you wish to download only a specific User and its details,
                  you can do so by:
                </p>
                <ol className="list-decimal pl-6 mb-4 text-justify">
                  <li>
                    Locate the User you wish to download the details of, either
                    by browsing for it or searching for it.
                  </li>
                  <li>
                    First, select the{" "}
                    <span className="text-primary-activelink font-bold">"Three dots"</span> icon
                    [It’ll look like this{" "}
                    <span className="text-primary-pheading font-bold">"⋮"</span>], located on the
                    right side of the User that you want to download the details
                    of.
                  </li>
                  <li>
                    You will then see the{" "}
                  ...
                  <li>
                    ...
                    the <span className="text-primary-pheading font-bold">"Download"</span>{" "}
                ...
                <p className="text-justify mb-4">
                  ...
                  download the PDF file. The PDF file will contain only the
    ...
    <div className="lg:pl-10 ">
                ...
                <p className="text-justify mb-4">
                  ...
                  <span className="text-primary-pheading font-bold">"’+’ Add New"</span> button
                  and above the table.
                </p>
                <p className="text-justify mb-4">
                ...
                <ul className="list-disc pl-6 mb-4 text-justify">
                  ...
                  <li>
                    The <span className="text-primary-pheading font-bold">"Status"</span> search:
                    You can search for the Users that are either{" "}
                    <span className="text-primary-activelink font-bold">"Active"</span> or{" "}
                    <span className="text-primary-activelink font-bold">"Blocked"</span> from the
                    Farm Management System.
                  </li>
                </ul>
                <p className="text-justify mb-4">
                  Then click on the{" "}
                  <span className="text-primary-pheading font-bold">"Search"</span> button,
                  located on the far-right of the page, to the right of the{" "}
                  <span className="text-primary-activelink font-bold">"Download Table"</span>{" "}
                  button and to the left of the{" "}
                  <span className="text-primary-pheading font-bold">"Refresh data"</span> button.
                </p>
                <p className="text-justify mb-4">
                  You will see the{" "}
                  <span className="text-primary-activelink font-bold">"Manage Users"</span> table
                  ...
                  <span className="text-primary-activelink font-bold">"arrow pointing back"</span>{" "}
                  icon.
                </p>
                <p className="text-justify mb-4">
                  ...
                  can <span className="text-primary-activelink font-bold">"Download Table"</span>{" "}
              ...
              <div className="flex items-center pt-5 space-x-4">
                ...
                <h4 className="text-lg font-semibold text-primary-activelink lg:pl-10 mb-2 text-justify">
                  Blocking a User
                </h4>
                <div className="lg:pl-10">
                <p className="text-justify mb-4">
