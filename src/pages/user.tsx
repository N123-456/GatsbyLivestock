              ...
              <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    user status will be active and cannot be changed. The field
                    is disabled. But you can later change the status if you want
                    to block access of any user to the system by changing its
                    status to blocked.
                  </li>
                  <li>
                    <span className="text-primary-pheading font-semibold">
                    ...
                    From this dropdown, you can define the role of user and can
                    decide much access user can have to the system. The user
                    roles are:
                  </li>
                  <br />
                  <br />
                  <ul className="text-primary-paragraph2 font-medium list-disc">
                    ...
                    <ul>
                      <li>
                        Access to operational features like plantings, resources
                        etc.
                      </li>
                      <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Cannot modify records, access settings, or create/assign
                        tasks/events.
                      </li>
                    </ul>
                    <br />
