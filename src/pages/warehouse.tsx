...
const harvest = () => {
  ...
  const data = useStaticQuery(graphql`
    query {
      ...
      bfw: file(relativePath: { eq: "bfw.png" }) {
        childImageSharp {
          gatsbyImageData(placeholder: BLURRED)
        }
      }
      sfw: file(relativePath: { eq: "sfw.png" }) {
        childImageSharp {
          gatsbyImageData(placeholder: BLURRED)
        }
      }
        ...
        <div className="flex flex-col justify-center ">
          <div className="acu lg:pr-4 text-justify font-montserrat text-[18px] text-primary-paragraph2">
            ...
            <div className="lg:pl-10">
              ...
              <p className="mb-4">
                This improves overall farm management and ensures timely access
              ...
              <p className="mb-4">
                ...
                <span className="font-bold">“Building”</span>, you can continue
                to making a{" "}
                <span className="text-primary-activelink font-bold">
                  Warehouse
                </span>{" "}
              ...
              <ol className="list-decimal ml-6 mb-4">
                <li className="mb-2">
                  ...
                  located on the top-left corner of the page, to the left of the{" "}
                  <span className="font-bold">“Download Table”</span> button and
                  to the top of the search options.
                </li>
                <div className="pl-13 pt-8 flex justify-center">
                  {aaw && (
                    <GatsbyImage
              ...
              <br />
              <p className="mb-4">
                Please keep in mind, all the details of each step must be filled
                properly.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                step is where you setup each section of the warehouse as well as
                their respective sub-sections and their rack setting. It
              ...
              <ul className="list-disc ml-6 mb-4">
                <li className="mb-2">
                  ...
                  machinery’s and any mechanical-based fluids (e.g. Brake fluid,
                  Carburetor fluid, Engine oil fluids, etc) for repairing those
                  machinery’s.
                </li>
                {/* <div className="pl-13 pt-8 flex justify-center">
                  {W && (
                ...
                <p className="mb-4">
                  ...
                  <span className="font-bold">“Add More”</span> button, located
                  below the{" "}
                  <span className="text-primary-activelink font-bold">
                    “Oil & Fluid”
                  </span>{" "}
                ...
                <ul className="list-disc ml-6 mb-4">
                  ...
                  <li className="mb-2">
                    ...
                    field: Enter the unit of measurement that the rack capacity
                    is using to set the size for the Rack.
                  </li>
                  <li className="mb-2">
                    The{" "}
                    <span className="text-primary-activelink font-bold">
                ...
                <p className="mb-4">
                  If you need to make space for a set of parts for a particular
                  machinery or tool, you can press the{" "}
                  <span className="font-bold">“Add More”</span> button, located
                  below the{" "}
                  <span className="text-primary-activelink font-bold">
                    “Spare Parts”
                ...
                <li className="mb-2">
                  ...
                  sub-section: This sub-section will hold the Parking spaces for
                  all the machinery’s (such as tractors, harvesters, chemicals
                  application sprayers, etc) that are solely important to the
                  farm operation.
                </li>
                {/* <div className="pl-13 pt-8 flex justify-center">
                  {W && (
                ...
                <ul className="list-disc ml-6 mb-4">
                  <li className="mb-2">
                    ...
                    field: Enter the name of the parking slot that will hold the
                    machinery that you are storing at the warehouse. Please
                    write a name that will be convenient for you and the farm
                    operation.
                  </li>
                  <li className="mb-2">
                    The{" "}
                    ...
                    field: Enter the capacity or space size of the parking slot
                    that will hold the machinery you are storing at the{" "}
                    <span className="text-primary-activelink font-bold">
                      Warehouse
                    </span>
                    .
                  ...
                  <li className="mb-2">
                    ...
                    field: Enter the unit of measurement that the rack capacity
                    is using to set the size for the parking slot.
                  </li>
                  <li className="mb-2">
                    The{" "}
                    <span className="text-primary-activelink font-bold">
              ...
              <ul className="list-disc ml-6 mb-4">
                <li className="mb-2">
                  ...
                  table, above the page select options and is on the bottom left
                  of the page.
                </li>
                {/* <div className="pl-13 pt-8 flex justify-center">
                  {W && (
                ...
                <li className="mb-2">
                  ...
                  entries do you want to see in one page. The default is set to
                  5. The options are 5, 10, 50 and 100. It is located below the{" "}
                  <span className="text-primary-activelink font-bold">
                    Warehouse
                  </span>{" "}
                ...
                <li className="mb-2">
                  ...
                  options: It shows which page you are currently in (The default
                  is the 1st page). It gives you buttons for the next five pages
                  after which it gives you the button to the last page. You can
                  also move to the previous page using the left arrow button,
                  located on the left side or to next page using the right arrow
                  button located on the right side. Located below the{" "}
                  <span className="text-primary-activelink font-bold">
                    Warehouse
                  </span>{" "}
                  table, the{" "}
                ...
                <li className="mb-2">
                  ...
                  search: You can type a page number of where the warehouse you
              ...
              <p className="mb-4">
                ...
                the <span className="font-bold">“Download Table”</span> button,
                and above the table.
              </p>
              <div className="pl-13 pt-8 flex justify-center">
                {sfw && (
              ...
              <br />
              <p className="mb-4">
                You can search based on these options going from left to right:
              </p>
              <ul className="list-disc ml-6 mb-4">
                <li className="mb-2">
                  <span className="text-primary-activelink font-bold">
              ...
              <p className="mb-4">
                ...
                can <span className="font-bold">“Download Table”</span> specific{" "}
                <span className="text-primary-activelink font-bold">
                  Warehouse
                </span>{" "}
              ...
              <ol className="list-decimal ml-6 mb-4">
                <li className="mb-2">
                  First, you can use the search to filter the table for specific
                  warehouses that you want to download, otherwise if you want to
                  download the entire table, leave the search options as it is
                  and go to the records per page count and set it to the highest
                  number you can set.
                </li>
                <li className="mb-2">
                  ...
                  <span className="font-bold">“Add Warehouse”</span> button and
                  above the search options of the page.
                </li>
                <li className="mb-2">
              ...
              <p className="mb-4">
                When you have found a suitable place for your PDF file, then you
                can press the <span className="font-bold">“Save”</span> button,
                located on the bottom right of your file explorer, so that it
                saves the PDF file to that folder.
              </p>
              <p className="mb-4">
                Now you can either go to the top-right hand of your browser and
                go into the Downloads section, to view your PDF file, or you can
                go into the file explorer location where you uploaded the PDF
                file and open it to view it as well.
              </p>
              <p className="mb-4">
              ...
              <ol className="list-decimal ml-6 mb-4">
                <li className="mb-2">
                  ...
                  you wish to view the tasks of. A small white box will show up
                  with a list of options you can go to.
                </li>
                <div className="pl-13 pt-8 flex justify-center">
                  {vttw && (
                    <GatsbyImage
                ...
                <br />
                <li className="mb-2">
                  Click on the <span className="font-bold">“Tasks”</span> button
                  which will be second and last on the list, below the{" "}
              ...
              <p className="mb-4">
                ...
                you selected. You can perform tasks-related matter in this page.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                entry within{" "}
                <span className="text-primary-activelink font-bold">FMS</span>{" "}
                and confirm the extra details about the information you entered.
                There are currently 2 methods to viewing a{" "}
                <span className="text-primary-activelink font-bold">
                  Warehouse
                </span>{" "}
                entry in the table.
              ...
              <p className="mb-4">
                ...
                clicking the <span className="font-bold">“View”</span> button in
                the menu that shows:
              </p>
              <ol className="list-decimal ml-6 mb-4">
                <li className="mb-2">
              ...
              <ol className="list-decimal ml-6 mb-4">
                ...
                <li className="mb-2">
                  ...
                  button, located at the top-right corner of the page, below the{" "}
                  <span className="font-bold">“Download”</span> button and to
                  the left of the{" "}
                  <span className="font-bold">
              ...
              <ol className="list-decimal ml-6 mb-4">
                <li className="mb-2">
                  ...
                  you wish to download the details of, either by browsing for it
                  or searching for it.
                </li>
                <li className="mb-2">
                  First, select the{" "}
