        ...
        <div className="flex flex-col justify-center">
          <div className="max-w-7xl w-full px-4 lg:px-4  text-justify">
            ...
            <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10 pt-4">
              ...
              essential nutrients that promote healthy growth and increase crop
              yield. They supply key nutrients like nitrogen, phosphorus, and
              potassium, which plants need for development. Fertilizers can be
              organic (e.g., compost, manure) or chemical-based, depending on
              the farm's needs. Proper use of fertilizers improves soil
              fertility, strengthens plants, and ensures better quality produce.
              It is important to apply the right type and amount of fertilizer
              to avoid harming crops or the environment. In the fertilizers tab,
              you will add the fertilizer applied to a specific crop.
            </p>
            ...
            <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
              ...
              <br />
              <p>
                Click on three dots against the crop you want to add fertilizer
                data.
              </p>
              ...
              <ul className="pl-[15px] list-disc">
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    ...
                    you bought the fertilizer i.e., the vendor’s name.
                  </li>
                  <div className="pl-13 pt-8 flex justify-center">
                    {AF1 && (
                      <GatsbyImage
              ...
              <p>
                If the fertilizer was a new buy, in that case it was an expense
                so a transaction will be created.
              </p>
              <br />{" "}
            </div>
            <div className="flex items-center pt-5 space-x-4">
