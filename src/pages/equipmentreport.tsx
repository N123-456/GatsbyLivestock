            ...
            <div className="text-justify lg:pr-4 hide-scrollbar text-primary-paragraph">
              <div className="flex items-center">
                ...
                <h2 className="text-primary-activelink font-semibold text-[30px] font-montserrat dark:text-[#D5D5D5]">
                  The Equipment Maintenance Reports
                </h2>
              </div>
              ...
              <div className="flex-1 h-px bg-primary-line"></div>
                ...
                <h1 className="text-primary-pheading font-bold">
                 How to get to the Equipment Maintenance Reports Page
                </h1><br />
 ...
 <div className="flex items-center pt-5 space-x-4 ">
              ...
              <div className="flex-1 h-px bg-primary-line"></div>
                ...
                <p className="font-montserrat text-[18px] ">
                  ...
                  page is where you can view the lists of the equipments and
                  their statuses entered in the “Machinery/Tools” page such as a
                  summary of the equipment that is owned by you or leased to
                  you, the maintenance of the machines, scheduled or
                  unscheduled, and finally the status of the equipments.
                  <br /> You can set the Date range for the Report so that you
                  can either see the overall progress over years or the progress
                  within a month.
                  <br /> You can also{" "}
                  <span className="text-primary-activelink font-bold">
                    download
                ...
                <p className="text-[18px] dark:text-[#D5D5D5]">
                  This Table is where you can view a list of Equipments and
                  their details that are under the Date range you set.
                </p>
                <div className="pl-13 pt-8 flex justify-center">
                  {fl && (
                    <GatsbyImage
                ...
                <p className="text-[18px] dark:text-[#D5D5D5]">
                  This Table is where you can view a list of Equipments that
                  have had scheduled maintenance’s, under the Date range you
                  set.
                </p>
                <div className="pl-13 pt-8 flex justify-center">
                  {fl && (
                ...
                <p>
                  This Table is where you can view a list of Equipments that
                  have had unscheduled maintenance’s, under the Date range you
                  set.
                </p>
                <div className="pl-13 pt-8 flex justify-center">
                  {fl && (
              ...
              <div className="flex-1 h-px bg-primary-line"></div>
                ...
                <p className=" text-[18px] font-montserrat font-normal dark:text-[#D5D5D5]">
                  If you want a custom date range of your equipment reports,
                  then you can set the date range by:
                </p>
                <ul className="font-montserrat text-[18px] dark:text-[#D5D5D5]">
                  <li>
                    First start by clicking the{" "}
...
<br /> <div className="flex items-center pt-5 space-x-4 ">
              ...
              <div className="flex-1 h-px bg-primary-line"></div>
                ...
                <p className="text-[18px] font-montserrat font-normal dark:text-[#D5D5D5]">
                  If you want to download the equipment report, then you can do
                  so by:
                </p>
                <ul className="font-montserrat text-[18px] dark:text-[#D5D5D5]">
                  <li>
                  ...
                  <li>
                    ...
                    Date Range for the Equipment Reports).
                  </li>
                  <li>
                  ...
                  <ul className="list-disc">
                    <li>
                      This file contains the current view of the Equipment
...
<br />
                  ...
                  <br />
                  <br />
                  <li>Now you know how to download an Equipment Report!</li><br />
                  <p>
