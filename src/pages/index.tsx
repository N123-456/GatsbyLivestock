        ...
        <main>
          <div className="flex flex-col justify-center">
            <div className="acu max-w-7xl w-full px-4 lg:px-4  text-justify">
              ...
              <p className="text-primary-paragraph dark:text-[#D5D5D5] text-[18px] font-montserrat font-normal lg:pl-10">
                ...
                getting better results. An integrated system for streamlined
                farm management. In this user manual, we will show you how to
                get started on the system and how to set up your farm. Let’s get
                started!
              </p>
              ...
              <p className="text-primary-paragraph dark:text-[#D5D5D5] text-[18px] font-montserrat font-normal lg:pl-10">
                ...
                how much cost has been incurred and whether you are gaining
                profit or are in loss. Also, you can see the graphical
              ...
              <p className="text-primary-paragraph2 dark:text-[#D5D5D5] text-[19px] font-montserrat font-normal lg:px-10">
                ...
                menu options. The menu is your gateway to all features, the menu
