        ...
        <div className="flex flex-col justify-center">
          <div className="content-container max-w-7xl w-full px-4 lg:px-4  text-justify">
            ...
            <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10 pt-4">
              The Field Inspection is used to monitor and evaluate the condition
              of crops and fields during the growing process. It involves
              checking the health of plants, identifying pests, diseases, or
              nutrient deficiencies, and assessing overall field conditions.
              Regular inspections help ensure timely actions such as applying
              fertilizers, pesticides, or irrigation when needed. This section
              allows farmers to keep track of observations, make informed
              decisions, and improve crop health and yield. By conducting field
              inspections, farmers can address potential issues early and ensure
              better productivity and farm management. A field inspection is
              conducted separately against a specific crop.
            </p>
            ...
            <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
              ...
              <ul>
                <li>
                  ...
                  was incurred on the field inspection, transaction details like
                  head of accounts, transaction id/ cheque no in case head of
                  accounts is bank, who was the customer.
                </li>
                <li>
                  <span className="text-primary-pheading font-semibold">
                    Plant Health Levels
                ...
                <li>
                  ...
                  : Intensity of heat wave (Severe, Moderate, Minor), intensity
                  of rainfall (Severe, Moderate, Minor), effect of wind on crop
                  (Severe, Moderate, Minor), smog density (Severe, Moderate,
                  Minor), hailstorm intensity (Severe, Moderate, Minor), and
                  frost condition (Severe, Moderate, Minor).
                </li>
                <br />
                <div className="pl-13 pt-8 flex justify-center">
                  {AFI1 && (
                ...
                <li>
                  ...
                  scouting took place and can also add images taken during field
                  inspection.
                </li>
                <div className="pl-13 pt-8 flex justify-center">
                  {AFI2 && (
              ...
              <p>
                A transaction will created as expense was incurred for carrying
