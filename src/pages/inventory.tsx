      ...
      <div>
        <div className="flex flex-col ">
          ...
          <p className="text-primary-paragraph text-[18px] font-montserrat font-normal px-10 pt-4">
            The inventory refers to the tracking and management of all items used on the farm, such as seeds, fertilizers, tools, and equipment. It helps farmers keep a record of the quantity, location, and condition of these items. It can also help monitor the cost of inputs and track their usage over time. The inventory system ensures that the farm runs smoothly, preventing shortages or excess inventory. This leads to better planning, cost savings, and improved farm productivity. It also allows for easy auditing and reporting of inventory data. 
          </p>
            ...
            <ul className="list-disc">
             ...
             {fl && (
              ...
              <li>
               ...
               This option is for if you found the difference between actual and available quantity present in warehouse. So, you can manually adjust the quantity. For doing this:
              </li>
              <ul>
                <li>❖ Click on “Manual Adjustment” button.</li>
                <li>❖ Enter the reason, the date on which you are making manual adjustment, choose the rack, and the difference in the available and actual quantity. In case you want to lessen the inventory, enter the quantity with negative sign.</li>
