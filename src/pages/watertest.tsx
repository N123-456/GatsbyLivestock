        ...
        <div className="flex flex-col justify-center">
          <div className="max-w-7xl w-full px-4 lg:px-4  text-justify">
            ...
            <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10 pt-4">
              ...
              including its pH, nutrient levels, and any harmful substances. It
              helps ensure the water is safe for crops, livestock, and
              irrigation systems. By testing water, farmers can identify issues
              like contamination or imbalances in minerals. This allows them to
              make informed decisions on water treatment or adjustments. Regular
              water testing is important to maintain healthy crops and
              livestock. It also helps prevent damage to irrigation equipment. A
              good water quality test ensures the best results for farming
              activities. The water test is an expense. When a water test is
              added, a transaction is created against that soil test. That can
            ...
            <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
              ...
              <ul className="PL-[15px]">
                ...
                <li>
                  ...
                  water, pH value, turbidity, total dissolved solids, dissolved
                  oxygen level, salinity, hardness, chloride, nitrate, and
                  fluoride value from the water test report.
                </li>
                ...
                <li>
                  ...
                  Enter the lead, arsenic, mercury, and cadmium value of water
                ...
                <li>
                  ...
                  Enter the pesticides and herbicides level found in water from
