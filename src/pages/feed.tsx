            ...
            <div className="content-container max-w-7xl w-full px-4 lg:px-4  text-justify">
              <div className="step2 pt-5">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10 pt-8">
                  The Feed/Forage Section is used for storing harvested crops
                  and animal feed. It ensures optimal conditions for storage to
                  ...
                  <ul>
                    ...
                    <li>
                      Add rack name (e.g. Rack 1), rack capacity (e.g. 100),
                      unit (e.g. bags), and description (e.g. This rack contains
                    ...
                    <li>
                      After adding all the racks for different portions, click
