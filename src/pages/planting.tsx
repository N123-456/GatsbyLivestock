          ...
          <div className="flex flex-col justify-center">
            <div className="content-container max-w-7xl w-full px-4 lg:px-4  text-justify">
              ...
              <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10 ">
                ...
                type, specifying the planting location, and entering details
                about the seeds, such as variety and source. Additional planting
                details include the planting depth, spacing, and any special
                instructions. You should also provide estimated harvest details,
                including the expected harvest date and anticipated yield. By
                accurately recording these details, farmers can monitor crop
                progress and optimize growth conditions for better yields.
                Moreover, you can add fertilizers and pesticides details applied
                on the crop. Also, the harvest details of the crop can be added.
  ...
  <div className="s1 pt-5">
              ...
              <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                <p>
                  ...
                  See the guide for adding farm location in the upper section of
                  the document. After choosing the crop, most of the fields will
                  be automatically filled based on predefined data, but you can
                  modify them as per your need. So, for adding planting:
                </p>
                <br />
                <br /> Click on{" "}
                ...
                want to plant and on which farm location you want to plant. How
                ...
                <p>
                  {" "}
                  If the crop will be planted in beds, enter the following
                  details:
                </p>
                <ul className="list-disc">
                  <br />
                  <li>
                    Choose the unit of measurement (Centimetre, Meter, Inch,
                    Feet).
                  </li>
                  <li>Enter how many beds you will use for planting.</li>
                  <li>Enter the length, width, and height of each bed.</li>
                  <li>Enter how many rows you will plant in each bed.</li>
                  <li>
                    Land Area will be calculated automatically on which the crop
                    will be planted.
                  </li>
                  <li>
                    Choose the direction for planting (Away from Sun, Towards
                    Sun).
                  </li>
                  <li>
                    If the crop is planted as cover crop, row crop or any other,
                    enter the following details:
                  </li>
                  <li>
                    Enter the land area on which the crop will be planted.
                  </li>
                  <li>
                    Choose the direction for planting (Away from Sun, Towards
                    Sun).
                ...
                <ul className="text-primary-subheading font-normal text-[18px] font-montserrat list-disc">
                  ...
                  <li>
                    Choose the unit of measurement for the seed quantity (e.g.,
                    KG, grams).
                  </li>
                  <li>
                    Enter the lot number of the seed batch for tracking
                    purposes.
                  </li>
                ...
                <ul className=" font-normal list-disc">
                  ...
                  <li>
                    Enter the specific variety of the crop you are planting.
                  </li>
                  <li>
                    Enter the distance between rows in your planting beds.
                  </li>
                  <li>
                    Choose how you are starting the crops (Nursery in Grounds,
                    Nursery in Trays, Bulbs/Cloves, Remove Root Stock, Grafting,
                    and Others).
                  </li>
                  <li>Enter the total number of plants per acre.</li>
                  <li>Enter the space between each plant in the row.</li>
                  <li>
                    Enter the expected number of days for the seeds to start
                  ...
                  <li>
                    Select the date and time for transplanting, if applicable.
                  </li>
                  <li>
                    Enter the estimated germination rate for the seeds
                    (percentage).
                  </li>
                  <li>
                    Choose the growth stage of the crop (Seed Started,
                    Germination, Seeding, Vegetative, Flowering, Ripening,
                    Complete). You can later modify the growth stage of the
                    crop.
                  </li>
                  <li>
                    If you will check the box, task will automatically be
                    created for that particular planting which you can modify or
                ...
                <ul className="font-normal text-[18px] font-montserrat list-disc">
                  ...
                  <li>
                    How many days it will take to harvest the crop will be
                    entered in harvest window.
                  </li>
                  <li>
                    How much you will lost during the harvest will be entered in
                    est. Harvest lost.
                  </li>
                  <li>Select the harvest unit (KG, Maunds)</li>
                  <li>
                    How much estimated yield will be produced will be entered in
                    Est. Yield Per Acre.
                  </li>
                  <li>
                    What is the unit price per kg/maund for that particular
                    crop.
                  </li>
                  <li>Estimated Revenue will be calculated automatically.</li>
                  <li>
                    How much average height will be of the crop at the time of
                    harvesting.
                  </li>
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  You can search the location from the list of farms of
                  ...
                  <p>
                    ...
                    You can search by the name of the crop.
                  </p>{" "}
                  <p>
                    <span className="text-primary-pheading font-semibold">
                      Growth Stage:
                    </span>{" "}
                    You can filter out that how much crops are in a particular
                    growth stage.
                  </p>
                  <p>
                    <span className="text-primary-pheading font-semibold">
                    ...
                    You can filter out which crop’s harvest are today, tomorrow,
                  ...
                  <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                    If you want to delete any crop planting, you can easily do
                    so.
                    <br />
                    <br />
                    <ul className="pl-[15px] list-disc text-primary-activelink font-semibold">
                      <li>
                        ...
                        delete in the planting’s table.
                      </li>
                      <li>
