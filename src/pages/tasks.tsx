            ...
            <div className="acu max-w-7xl w-full px-4 lg:px-4  text-justify">
              ...
              <div className="at pt-5">
                ...
                <p className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  ...
                  of Accounts, Customer, transaction id etc., status of task,
                  who will perform the task, how much is the task important,
                  when will the task start and end, will the task be repeated or
                  not, and how much time will be spent on the task. When a task
                  is completed, a transaction is created against that task. That
                  can be viewed in the financial tab in general ledger table.
                </p>
              </div>
              <div className="pl-13 pt-8 flex justify-center">
                {addtask && (
              ...
              <div className="tf pt-5">
                ...
                <p className="text-primary-paragraph2 text-[19px] font-montserrat font-normal lg:px-10">
                  ...
                  : It will tell the name of the task to be done. (e.g.
                  Ploughing)
                  <br />{" "}
                  <span className="text-primary-pheading font-semibold">
                    Description
                  ...
                  : It will include details like head of accounts, transaction
                  id, and customer name.
                  <br />{" "}
                  <span className="text-primary-pheading font-semibold">
                    Task Status
                  </span>
                  : What is the status of the task i.e., on what stage the task
                  is at. When a task is created its status cannot be completed.
                  Later on, when the task will be completed you will edit the
                  status to completed. The other status of task can be:
                  <ul className="list-disc list-inside text-primary-activelink font-semibold text-[18px]">
                    <li>Pending</li>
                    <li>In-Progress</li>
                    <li>Cancelled</li>
              ...
              <div className="st pt-5">
                ...
                <p className="text-primary-paragraph2 text-[19px] font-montserrat font-normal lg:px-10">
                  ...
                  today, tomorrow, this week, next week, next month or can
                  choose a custom range in which tasks were or will be
                  performed.
              ...
              <div className="et pt-5">
                ...
                <p className="text-primary-paragraph2 text-[19px] font-montserrat font-normal lg:px-10">
                  If any tasks detail you want to change, you can easily edit
                  the details except for the transaction details related to the
                  task. For that:
                  <br />
                  <ul className="list-disc list-inside text-primary-activelink font-semibold text-[18px]">
