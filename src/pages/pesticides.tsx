        ...
        <div className="flex flex-col justify-center">
          <div className="content-container max-w-7xl w-full px-4 lg:px-4  text-justify">
            ...
            <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10 pt-4">
              ...
              crops from pests, insects, weeds, and diseases. They help prevent
              damage to plants, ensuring healthy growth and higher yields.
              Pesticides can be classified into types such as insecticides (for
              insects), herbicides (for weeds), and fungicides (for fungi).
              Proper and safe use of pesticides is important to avoid harm to
              crops, soil, and the environment. Following recommended guidelines
              ensures effective pest control while maintaining food safety. In
              the pesticides tab, you will add the pesticides applied to a
              specific crop.
            </p>
            ...
            <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
              ...
              <br />
              <p>
                Click on three dots against the crop you want to add pesticides
                data.
              </p>
              ...
              <ul className="list-disc ">
                <li>
                  Enter the product details including product name, brand of the
                  pesticide, when was the pesticide applied to the crop, how
                  much effective was the pesticide i.e., pesticide efficiency in
                  percentage.
                </li>
                ...
                <ul className="list-disc">
                  <li>
                    ...
                    choose the option <span className="text-primary-activelink font-bold">“inventory”.</span>
                  </li>
                  ...
                  <li>
                    ...
                    option <span className="text-primary-activelink font-bold">“New Buy”.</span>
                  </li>
                  <li>
                    ...
                    id/cheque no in case head of accounts is bank, and from whom
                    you bought the pesticide i.e., the vendor’s name.
                  </li>
                  <div className="pl-13 pt-8 flex justify-center">
                    {APE1 && (
                      <GatsbyImage
