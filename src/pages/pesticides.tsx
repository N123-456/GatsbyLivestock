              ...
              <div className="ap pt-5">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  ...
                  <ul className="list-disc ">
                    ...
                    <ul className="list-disc">
                      <li>
                        If the pesticide you applied was taken from the
                      ...
                      <li>
                        Enter the details when the pesticide was bought, how
                        much did the pesticide cost, how much quantity did you
                        buy, transaction details like head of accounts,
                        transaction id/cheque no in case head of accounts is
                        bank, and from whom you bought the pesticide i.e., the
                        vendor’s name.
                      </li>
                      <div className="pl-13 pt-8 flex justify-center">
                        {APE1 && (
