            ...
            <div className="acu max-w-7xl w-full px-4 lg:px-4  text-justify">
             <div className="flex items-center pt-5">
                ...
                <p className="text-primary-paragraph text-[18px] font-montserrat font-normal lg:px-10">
                  A soil test checks the soil's health by measuring its
                  nutrients and pH levels. It helps farmers understand what
                  nutrients their soil needs. By testing the soil, farmers can
                  make better choices about fertilizers, and which crops to
                  grow. The test also prevents wasting fertilizers and helps
                  save money. It improves crop growth and keeps the soil healthy
                  in the long run. Regular soil tests are important for good
                  farm management. This way, farmers can get the best results
                  from their land. The soil test is an expense. When a soil test
                  is added, a transaction is created against that soil test.
                  That can be viewed in the financial tab in general ledger
                  table.
                </p>
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Enter the details of soil type and soil colour from the
                      soil test report.
                    </li>
                    ...
                    <li>
                      ...
                      Enter the PH and EC value of soil from the soil test
                      report.
                    </li>
                    <li>
                      <span className="text-primary-pheading font-semibold">
                      ...
                      sulphur, zinc, iron, manganese, copper, boron, calcium,
                      and magnesium from the soil test report.
                    </li>
              ...
              <div className="pl-13 pt-8 flex justify-center">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  You can search the soil test from the list of soil tests
              ...
              <div className="pl-13 pt-8 flex justify-center">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  If any soil test detail you want to change, you can easily
