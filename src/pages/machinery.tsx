              ...
              <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  ...
                  <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                    ...
                    for how much time the machinery was used. Also, you can get
                    an overview of weekly, monthly and yearly usage for all the
                    ...
                    <ul className="pl-[15px] list-disc text-primary-activelink font-bold">
                      ...
                      <li>
                        ...
                        machineries are being used over specific time period.
                        You can also see which machinery is the most used one
                        and which one needs more attention.
                      </li>
                      <li>
