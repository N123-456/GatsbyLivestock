          ...
          <div className="flex flex-col justify-center">
            <div className=" max-w-7xl w-full px-4 lg:px-4  text-justify">
              <div className="contact">
                <TextToSpeech textSelector=".contact" />
              ...
              <div className="add pt-5">
                ...
                <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                  ...
                  <p>
                    Fill out the required details. The details of fields are:
                  </p>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      It is an optional field. If user has any alternative
                    ...
                    <li>
                      ...
                      Role of the contact related to your farm. The roles can
                      be.
                    </li>
                    <ul className="text-primary-paragraph2">
                      <li>
                        ...
                        Reviews and verifies the accuracy of financial records
                      ...
                      <li>
                        ...
                        Oversees system operations, tasks, and team activities
                ...
                <div className="search pt-5">
                  ...
                  <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                    You can search the contact from the list of contacts present
                    in the system. You can search based on either:
                    <br />
                    <ul>
                      <li>
                        <p>
                  ...
                  <div className="ec pt-5">
                    ...
                    <div className="text-primary-paragraph2 text-[18px] font-montserrat font-normal lg:px-10">
                      If any contacts details you want to change, you can easily
